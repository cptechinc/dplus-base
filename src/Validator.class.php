<?php
    ...
    class Validator {
        ...
        /**
         * Validate that value is an integer, float/decimal, bool, or string. Value can be zero (0) or FALSE.
        ...
        /**
         * Returns if string matches 10 digit phone number
         * @param  string $str String to Match Phone Number against
         * @return bool        Does string match regex for 10 digit phone number?
         */
        public function phone_10($str) {
            $regex = "/\d{3}-?\d{3}-?\d{4}/i";
